...
CategoryReward.create!(
  ...
  description: "Complete 6 challenges of the shopping category",
  name: "Base Shopper",
  colour: "#C4C4C4",
  min_challenges: 0,
  max_challenges: 1
...
CategoryReward.create!(
  ...
  description: "Complete 6 challenges of the mobility category",
  name: "Base Mobilizer",
  colour: "#C4C4C4",
  min_challenges: 0,
  max_challenges: 1
...
CategoryReward.create!(
  ...
  description: "Complete 6 challenges of the investment category",
  name: "Base Investor",
  colour: "#C4C4C4",
  min_challenges: 0,
  max_challenges: 1
...
CategoryReward.create!(
  ...
  icon: "food-base.svg",
  description: "Complete 6 challenges of the food category",
  name: "Base Foodie",
  colour: "#C4C4C4",
  min_challenges: 0,
  max_challenges: 1
...
CategoryReward.create!(
  ...
  icon: "home-base.svg",
  description: "Complete 6 challenges of the home category",
  name: "Base Homie",
  colour: "#C4C4C4",
  min_challenges: 0,
  max_challenges: 1
